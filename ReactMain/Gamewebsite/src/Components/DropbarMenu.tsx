...
const DropbarMenu = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div id='Pause' className={state.menustatus? styles.pause : styles.pausesleep} onClick={() => {goto('/pause');MapStore.update(s => {s.menustatus = !s.menustatus})}}><a><img src={LabelPause} alt="" /></a></div>
            ...
            <div id='Out' className={state.menustatus? styles.outgame : styles.outgamesleep}><a onClick={() => {goto('/');MapStore.update(s => {s.menustatus = !s.menustatus})}}><img src={LabelOut} alt="" /></a></div>
