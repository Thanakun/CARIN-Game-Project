...
import GreenAntigen from '../Images/Green Antigenv2.png'
import YellowAntigen from '../Images/Yellow Anitigenv2.png'
import BlueAntigen from '../Images/Blude Antigenv2.png'
