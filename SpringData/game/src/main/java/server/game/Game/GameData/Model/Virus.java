...
public class Virus extends Entity implements Organism{
    ...
    public Virus(String id, int type,int[] location_init,PositionMap positionMap,OrganismStorage organismStorage){   // for virus Id format is "V??????" ?is any number or character
        this.Id = id;
